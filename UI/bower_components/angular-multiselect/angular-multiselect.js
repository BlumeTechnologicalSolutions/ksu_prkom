    ...
    function ($filter, $document, $compile, $parse) {
        ...
        return {
            ...
            template: function (element, attrs, $scope) {
                ...
                template += '<li ng-hide="!settings.showCheckAll || settings.selectionLimit > 0"><a class="pointer" data-ng-click="selectAll()"><span class="glyphicon glyphicon-ok "></span>  {{texts.checkAll}}</a>';
                template += '<li ng-show="settings.showUncheckAll"><a class="pointer" data-ng-click="deselectAll();"><span class="glyphicon glyphicon-remove"></span>   {{texts.uncheckAll}}</a></li>';
